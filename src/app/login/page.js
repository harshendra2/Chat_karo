  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200 || response.status === 201) {
        ...
        // Set cookies using js-cookie for better compatibility
        Cookies.set("currentUser", response.data.userToken, {
          path: "/",
    ...
    <LoginProtectedRoute>
      <div className="h-screen flex flex-col"> 
        ...
        <main className="flex-grow w-full flex flex-col items-center justify-center"> 
          <div className="md:w-full sm:max-w-md space-y-6 text-gray-400 px-4 -mt-[10%]">
            <div className="text-center">
              <div className="mt-0 space-y-2">
                <h3 className="text-gray-400 text-4xl font-extrabold sm:text-3xl">
